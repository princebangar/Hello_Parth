  ...
  const links = [
    {
      ...
      url: 'https://play.google.com/store/apps/details?id=com.helloparth.user',
      type: 'Customer App',
    ...
    {
      id: 'driver',
      title: 'Hello Parth Driver',
      subtitle: 'Drive and earn with Hello Parth.',
      description: 'Join our fleet of professional drivers. Flexible hours, great earnings, and a supportive community.',
      url: 'https://play.google.com/store/apps/details?id=com.helloparth.driver',
      type: 'Partner App',
  ...
  return (
    <div className="links-page-container">
      <nav className="links-nav">
        <div className="nav-container">
          <a href="/" className="nav-logo">
            <span className="logo-rydon">Hello Parth</span>
          </a>
      ...
      <div className="links-banner">
        <img src={bannerImg} alt="Hello Parth Banner" className="banner-image" />
        <div className="banner-gradient"></div>
      </div>

      <div className="links-content-wrapper">
        <header className="links-header">
          <h1 className="links-title">Download <span className="highlight">Hello Parth</span></h1>
